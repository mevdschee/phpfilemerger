...
[PHP‑CRUD‑API](https://github.com/mevdschee/php-crud-api), where this project is
may be used to flatten multiple PHP source files into a single distributable
script.
